...
const double WHEEL_BASE = 0.375; // Center of left tire to center of right tire
...
void set_initial_2d(const geometry_msgs::PoseStamped &rvizClick) {
    ...
    // std::cout << "set_initial_2d" << std::endl;
}
...
int main(int argc, char **argv) {
    ...
    // ros::Subscriber subInitialPose = node.subscribe("bot_initialpose", 1, set_initial_2d);
    ...
    ros::Duration loop_rate(1/50.0);  // 0.02s
